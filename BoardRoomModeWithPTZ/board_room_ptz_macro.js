...
const MAP_CAMERA_SOURCE_IDS = [1,2];
...
// sourceDict={ Source : '0'};"
const overviewShowDouble = false;
...
// Static configuration of PTZ will be set when macro initializes only
const PTZ_CAMERA_ID = 2;
const PTZ_CAMERA_PAN = 1000;
const PTZ_CAMERA_TILT = 1000;
const PTZ_CAMERA_ZOOM = 1000;

/////////////////////////////////////////////////////////////////////////////////////////
// VARIABLES
/////////////////////////////////////////////////////////////////////////////////////////
let AUX_CODEC={ enable: false, online: false, url: AUX_CODEC_IP, auth: AUX_CODEC_AUTH};
let micArrays={};
...
function init() {
  ...
  xapi.Status.Standby.State
    ...
    // set the PTZ Camera's center index in case it was manually moved
    xapi.command ('Camera PositionSet',{CameraId: PTZ_CAMERA_ID, Pan: PTZ_CAMERA_PAN, Tilt: PTZ_CAMERA_TILT, Zoom: PTZ_CAMERA_ZOOM});
...
function makeCameraSwitch(input, average) {
  ...
  console.log("-------------------------------------------------");
    // TODO: why was this not there before, how was SpeakerTrack turning back on after side by side mode??
  xapi.command('Cameras SpeakerTrack Activate').catch(handleError);
